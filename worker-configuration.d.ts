/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7d78ad3e2c1356e8308b7b617d84b515)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	EVM_PRIVATE_KEY: string;
	ATTOM_API_KEY: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/worker").RealEstateMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "RealEstateMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EVM_PRIVATE_KEY" | "ATTOM_API_KEY">> {}
}
